...
export default function AIChat() {
  ...
  const getAIResponse = (userMessage: string): string => {
    ...
    if (message.includes('expense') || message.includes('spending') || message.includes('biggest')) {
      ...
      return "I understand you're asking about your finances. Based on your current data, I can help you with spending analysis, investment advice, debt management, and financial planning. Could you be more specific about what you'd like to know?"
    }
  }
